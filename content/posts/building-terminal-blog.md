...
| Gemini 3.1 Flash Lite | AI 답변 (`ask` 명령어) |
...
분류는 Gemini 3.1 Flash Lite로 "rag"/"chat" 중 하나를 반환하게 했다. 분류 호출이 하나 추가되지만, 불필요한 임베딩 API 호출과 Pinecone 쿼리를 아낄 수 있어서 전체적으로 효율적이다.
