...
- 2026-04-11: `content/digest/2026-04-11.md`를 `daily-digest` 하드 룰에 맞춰 재생성했다. 카테고리별 서브에이전트 초안(`sns/news/reddit/youtube/hf1/hf2/hf3/arxiv1/arxiv2/arxiv3a/arxiv3b`)을 모은 뒤 퇴고 에이전트가 `58`개 `Draft-ID`, `58`개 `###`, `1211`줄 구조로 통합했고, `merge-plan.md` 대조와 기준선 digest(`2026-04-08`) 대비 밀도 검증을 통과하도록 수치와 사례를 보존했다.
